...
from lib.detection_eval_sql import (
    ...
    DETECTION_STATS_SKIP_INITIAL_FRAMES,
    build_filter_clause,
    create_view_eval_flat,
    default_parquet_index,
    list_parquets_in_run,
    sql_distance_bin_label_rates_from_eval_flat,
    sql_distance_bin_rates_from_eval_flat,
)
from lib.detection_eval_sql import (
    ensure_detection_stats_eval_flat_cache as _ensure_detection_stats_eval_flat_cache,
    kpi_row_for_view as _kpi_row_for_view,
)
...
from lib.detection_llm_package import (
    llm_prompt_to_paste as _llm_prompt_to_paste,
    report_consecutive_failure_phrases as _report_consecutive_failure_phrases,
    report_critical_case_phrases as _report_critical_case_phrases,
    report_degraded_object_details as _report_degraded_object_details,
    report_diff_by_label as _report_diff_by_label,
    report_diff_by_scene_or_frame as _report_diff_by_scene_or_frame,
    report_error_metrics as _report_error_metrics,
    report_fn_frames as _report_fn_frames,
    report_fp_diff_tables as _report_fp_diff_tables,
    report_frame_ref as _report_frame_ref,
    report_int as _report_int,
    report_label_distance_compare as _report_label_distance_compare,
    report_label_metrics as _report_label_metrics,
    report_nonempty_text as _report_nonempty_text,
    report_scene_metrics as _report_scene_metrics,
    safe_export_filename as _safe_export_filename,
)
